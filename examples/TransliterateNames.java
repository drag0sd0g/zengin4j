 ...
 * </pre>
 *
 * <p>Names in a CRM or payroll system are full-width, mixed case, and sometimes
...
public final class TransliterateNames {
     ...
     *
     * <p>R-K2 says ー becomes ｰ and ャ becomes ｬ. Neither is permitted in any
     ...
     *
     * <p>A long vowel becomes a hyphen, and payroll names admit no symbols — so
     ...
     *
     * <p>ｶﾞ is two bytes with one glyph. A cut between them turns ガ into カ and
