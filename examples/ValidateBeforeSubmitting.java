...
/// ```
///
/// The file below has five things wrong with it, of three different kinds:
...
///
/// Every identifier here is invented (R-L1, P1).
void main() {
...
///
/// - a trailer total that disagrees with its payments — V-301, an error;
/// - a duplicated payment — V-306, a warning, and usually a pasted row;
/// - a payee name written with ｰ instead of - — V-202, the mistake that
///   looks correct;
/// - a zero amount — V-602;
/// - a value date on a Saturday — V-501, which needs a calendar.
