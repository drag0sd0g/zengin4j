...
/// ```
///
/// Three things a fixture generator has to be able to do, in order: build a
...
///
/// Every identifier here is invented, and outside the ranges real Japanese
/// institutions use: bank `9999`, branch `999`, accounts beginning
/// `9` (R-L1, P1).
void main() {
