...
/// ```
///
/// **Every value here is invented** (R-L1). Bank `9999`,
/// branch `999` and accounts beginning `9` are outside the ranges
...
///
/// The same ground is covered by `zengin generate` for anyone who would
...
///
/// Reading them back is the part that matters. A generator that emits
