...
/// for all of them.
///
/// Stands in for a property-testing library. It gives up automatic shrinking
/// — a failure arrives as generated rather than minimised — and buys that back
/// two ways. Generators here deliberately produce *small* inputs (one to
...
/// with [#single] instead of re-running the whole property.
///
/// Hostile, unstructured input is not this class's job. That is fuzzing, and
/// `ReaderFuzzTest` hands it to Jazzer, which is coverage-guided and does
/// it far better than random generation can.
///
/// See `docs/adr/0017-property-testing-without-jqwik.md`.
