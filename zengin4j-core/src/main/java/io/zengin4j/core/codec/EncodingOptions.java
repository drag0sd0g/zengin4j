...
///
/// Defaults to refusing anything the field cannot hold. That is the shape P5
...
public final class EncodingOptions {
    ...
    ///
    /// @return `false` only when a caller has deliberately turned it off
    ...
    public static final class Builder {
        ...
        ///
        /// **For building files that are deliberately wrong.** A
        ...
        ///
        /// Not a fourth write policy. R-C18 names three, and all three
