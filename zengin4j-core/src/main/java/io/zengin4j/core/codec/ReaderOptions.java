...
/// How to read a file.
///
/// Immutable and thread-safe. Build one and share it.
///
/// @since 0.1.0
public final class ReaderOptions {
    ...
    ///
    /// Loads a fresh [FormatRegistry] on each call. Reading many files
    /// means building one registry and passing it to
    /// [Builder#registry(FormatRegistry)] instead (R-0.10).
    ///
    ...
    ///
    /// @return the charset; [ZenginCharset#MS932] by default
    ...
    ///
    /// @return the parse mode; [ParseMode#STRICT] by default
    ...
    ///
    /// @return the policy; [ByteOrderMarkPolicy#REJECT] by default
    ...
    ///
    /// Not thread-safe; the options it builds are.
    ///
    /// @since 0.1.0
    public static final class Builder {
        ...
        ///
        /// Every format shipped in 0.1.0 is unverified, so reading anything
        ...
        ///
        /// For institutions that emit records longer than the standard
        ...
        /// not permit (R-C13).
        ///
        /// @param value the policy; [CharacterPolicy#IGNORE] by default
        /// @return this builder
