...
///
/// Each format's generated code supplies one of these, so that
/// [RecordView#materialize()] produces the format-shaped type
/// (`SougouFurikomiData` and friends) rather than a map of strings.
/// Formats registered at runtime, which have no generated code, fall back to
/// the descriptor-driven `Generic*` records.
///
/// @since 0.1.0
@FunctionalInterface
