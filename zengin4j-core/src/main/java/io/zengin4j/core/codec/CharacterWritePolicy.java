 ...
 *
 * <p>Distinct from {@link CharacterPolicy}, which is the read side. Reading a
 * character the standard forbids is a fact about somebody else's file and worth
 * reporting; <em>writing</em> one is this library producing a file it would
...
public enum CharacterWritePolicy {
     ...
     *
     * <p>The value came from the caller, who knows what it was meant to be. A
     ...
     *
     * <p>Full-width becomes half-width, a long vowel becomes a hyphen, a small
     ...
     *
     * <p>A last resort, for a caller feeding a system that will accept a
