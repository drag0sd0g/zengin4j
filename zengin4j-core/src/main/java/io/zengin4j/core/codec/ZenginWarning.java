...
///
/// Warnings are not findings. A finding says a file violates the format and
...
///
/// Every warning is collected on the reader and also handed to the listener
/// configured in [ReaderOptions]. The default listener writes one line
/// through [System.Logger], which is part of `java.base` and so
...
/// @param byteOffset where in the file the warning applies, or `-1`
/// @since 0.1.0
public record ZenginWarning(String code, String messageEn, String messageJa, long byteOffset) {
    ...
    /// Writes this warning through [System.Logger] at `WARNING`
