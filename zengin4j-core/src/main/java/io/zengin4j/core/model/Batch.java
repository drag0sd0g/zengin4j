 ...
 *
 * <p>A file may carry several batches even where a particular institution
...
public record Batch(
     ...
     *
     * <p>Compare with {@code trailer().recordCount()} to check the file's own
     ...
     *
     * @return the total
     * @throws AmountOverflowException if the sum exceeds a {@code long}; the
     ...
     *
     * @return {@code true} if a trailer is present
     */
