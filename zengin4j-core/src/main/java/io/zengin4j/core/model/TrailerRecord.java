 ...
 *
 * <p>The values here are what the file <em>claims</em>. Comparing them against
 * what the data records actually contain is a validation concern
 * ({@code V-301}, {@code V-302}); this type does not reconcile them.
 *
 * @since 0.1.0
 */
public non-sealed interface TrailerRecord extends ZenginRecord {
     ...
     *
     * <p>The field is {@code N(12)}, so the maximum representable total is
