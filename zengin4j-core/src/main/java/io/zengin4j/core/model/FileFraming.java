...
///
/// Byte-exact round-tripping (INV-1) needs more than the records: a file
...
/// @param trailingSeparator    whether a separator followed the *last*
...
///   OQ-4
/// @param trailingEofByte      whether the file ended with `0x1A`
///   (R-C8)
/// @since 0.1.0
public record FileFraming(
    ...
    ///
    /// @return `false` if the file mixed separator conventions
    ...
    ///
    /// @return `false` for [SeparatorStyle#NONE]
