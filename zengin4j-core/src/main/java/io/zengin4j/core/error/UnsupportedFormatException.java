 ...
 * the header record.
 *
 * <p>This is the "absent" state of the verification protocol (§0.3): the
 * format is not implemented, as opposed to implemented-but-unverified, which
 * raises {@link UnverifiedFormatException} instead.
 *
 * @since 0.1.0
 */
public final class UnsupportedFormatException extends ZenginException {
     ...
     *                 registered, for example {@code "21"}
     */
     ...
     *
     * @return the two-character business type code, never {@code null}
     */
