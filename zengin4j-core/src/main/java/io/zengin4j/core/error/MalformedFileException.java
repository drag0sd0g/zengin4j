 ...
 *
 * <p>In lenient mode the same conditions produce a
 * {@link io.zengin4j.core.model.MalformedRecord MalformedRecord} and parsing
...
public final class MalformedFileException extends ZenginException {
     ...
     *                     detected, or {@code 0} before the first record
     ...
     *
     * @return the record number, or {@code 0} if the problem precedes the
     *         first record
     */
