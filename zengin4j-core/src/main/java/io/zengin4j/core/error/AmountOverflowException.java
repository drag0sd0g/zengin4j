...
/// Summing the amounts in a batch overflowed a `long`.
///
/// R-D7 requires that an overflow is detected and reported, never silently
...
///
/// The validation layer computes totals with its own overflow-tolerant loop
/// and reports a finding instead (§19.3, rule `V-303`); this exception is
/// for callers who ask `core` for the sum directly.
///
/// @since 0.1.0
