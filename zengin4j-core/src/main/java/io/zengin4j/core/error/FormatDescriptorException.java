...
///
/// Raised for, among others: field lengths that do not sum to the declared
/// record length (R-F1), a duplicate field id, an unresolvable code-list
/// reference, and `verified: true` with fewer than two cited sources
...
public final class FormatDescriptorException extends ZenginException {
    ...
    ///
    /// @return the format id or resource name, never `null`
    ...
    ///
    /// @return the problem description, never `null`
