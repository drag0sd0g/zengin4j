...
public final class Diagnostics {
     ...
     *
     * <p>Values no longer than {@value #VISIBLE_TRAILING_CHARS} characters are
     ...
     *
     * @param value the identifier to mask, may be {@code null} or blank
     * @return the masked identifier; {@code null} and blank inputs are
     *         returned unchanged
     */
