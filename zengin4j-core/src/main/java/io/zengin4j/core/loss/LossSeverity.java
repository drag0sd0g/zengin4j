 ...
 *
 * <p>The distinction is about consequences, not about how much text changed.
...
public enum LossSeverity {
     ...
     *
     * <p>Case folding, half-width to full-width widening, a dropped field that
     ...
     *
     * <p>キャノン becoming キヤノン is material: a human matching the payment
     ...
     *
     * <p>Reserved for losses that can move money to the wrong place. Callers
