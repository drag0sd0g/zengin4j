 ...
 *
 * <p><strong>No operation in this library loses information silently.</strong>
 * Anything that truncates, transliterates, drops, defaults or coerces a value
 * records a {@link io.zengin4j.core.loss.LossEntry} saying what it did, what
 ...
 * log nobody reads.
 *
 * <p>These types live in {@code core} rather than in the mapping layer because
 * transliteration needs them and transliteration is a write-side concern: the
 * writer's {@code TRANSLITERATE} policy (R-C18) is in {@code core}, and
 * {@code core} depends on no other module. The ISO 20022 layer builds its
