...
///
/// Every default refuses. That is the shape P5 asks for: a conversion that
...
public final class TransliterationOptions {
    ...
    /// [TruncationPolicy#TRUNCATE_WITH_MARKER].
    ///
    /// Must be a character the target field admits, which rules more out than
    /// it looks: `*` is permitted by no name class at all, and
    /// [io.zengin4j.core.charset.CharacterClass#PAYROLL_NAME] admits no
    ...
    public static final class Builder {
        ...
        ///
        /// This is not a formality. A long vowel becomes a hyphen, and
        /// [CharacterClass#PAYROLL_NAME] admits no symbols, so the same
        ...
        /// Sets the marker for [TruncationPolicy#TRUNCATE_WITH_MARKER].
        ///
