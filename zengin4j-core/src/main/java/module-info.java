...
///
/// **Zero runtime dependencies (R-M1).** This module requires
/// nothing beyond `java.base`, which is what makes it adoptable in
...
///
/// Format descriptors are authored as YAML and compiled into this module by
