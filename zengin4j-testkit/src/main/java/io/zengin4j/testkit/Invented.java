...
///
/// Kept in one place so the four formats cannot drift into using different
...
/// defines one and documents it: bank `9999`, branch `999` and
/// `998`, accounts beginning with `9`.
///
/// The CI identifier scan asserts that nothing outside these ranges appears
...
final class Invented {
    ...
    /// Bank name: ﾃｽﾄｷﾞﾝｺｳ.
    ///
    /// Seven characters, eight bytes: ｷﾞ is a base kana followed by a
