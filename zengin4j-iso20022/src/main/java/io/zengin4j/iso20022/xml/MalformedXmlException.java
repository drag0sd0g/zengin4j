 ...
 *
 * <p>Either they are not well-formed, or they exceed a limit the parser imposes
 * on untrusted input — see {@link XmlParser} for what those limits are and why
 * a size bound is a correctness property here rather than a tuning knob.
 *
 * <p>This is the one place the library's usual rule bends. Elsewhere a
...
public final class MalformedXmlException extends ZenginException {
     ...
     *
     * @param byteOffset the byte offset at which parsing stopped, or {@code -1}
     ...
     *
     * @return the offset, or {@code -1} if unknown
     */
