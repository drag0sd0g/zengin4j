 ...
 *
 * <p>{@code PartyIdentification32} carries a postal address, contact details
 ...
 *
 * @param name       {@code Nm} — up to 140 characters, any script
 * @param identifier {@code Id/OrgId/Othr/Id} — the organisation identifier,
...
public record Party(String name, String identifier) {
     ...
     *
     * @param element the {@code InitgPty}, {@code Dbtr} or {@code Cdtr} element
     * @return the party
     */
     ...
     * Renders the party.
     *
     * @param name the element name to use — {@code InitgPty}, {@code Dbtr} or
     *             {@code Cdtr}
