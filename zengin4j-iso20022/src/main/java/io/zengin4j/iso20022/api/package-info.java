/// The conversion API: `Iso20022Mapper` and what it needs and returns.
///
/// Two rules shape everything here. A conversion always returns its loss
/// report alongside its output, and there is no method that returns the output
/// alone (R-I14). And the downward leg always takes a `MappingContext`,
