...
///
/// R-I18 calls this the honest demonstration that conversion is not
...
/// out and dropped on the way in; an `EndToEndId` that fits in
/// thirty-five characters does not fit in ten.
///
/// [#isByteIdentical()] is therefore usually false, and that is the
...
public record RoundTripResult(
    ...
    ///
    /// Compares the records' raw bytes rather than their decoded values, for
