...
///
/// R-I6 asks for byte-identical framing. This achieves it by not having a
...
///
/// A message built from a mapping serialises itself, and every document
/// `XmlSerializer` produces ends in CRLF — so a header followed by a body
