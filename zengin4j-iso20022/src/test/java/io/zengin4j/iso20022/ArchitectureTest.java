 ...
 * exception.
 *
 * <p>R-M3 permits this module an XML dependency — it is the only one that may
 * have one — and it turns out not to need it: {@code java.xml} is in the JDK,
...
class ArchitectureTest {
     ...
     *
     * <p>R-M1 constrains {@code core}, not this module. Holding this module to
     ...
     *
     * <p>An XML parser resolving a schema location, or a validator fetching an
     ...
     *
     * <p>{@code pain001} describes a message; {@code envelope} describes how the
