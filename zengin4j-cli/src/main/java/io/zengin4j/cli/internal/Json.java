...
///
/// Hand-written, for the reason ADR-0022 gives and one more that is specific
...
/// and cannot go stale.
///
/// Emitting is not the same problem as parsing. This escapes five characters,
...
public final class Json {
    ...
    ///
    /// Japanese text passes through as itself: the output is UTF-8 and JSON
    /// permits any Unicode character in a string, so `\\u` escaping
