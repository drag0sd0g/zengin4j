...
///
/// **Optional and pluggable, and the library is complete without it.**
...
///
/// `zengin-code` is the obvious public dataset to wire up, and
/// [MapReferenceData] loads that shape.
///
/// @since 0.2.0
public interface ReferenceDataProvider {
    ...
    /// @return `true` if the provider knows it
    ...
    ///
    /// @return a short description, never `null`
    String describe();
}
