...
///
/// Optional and pluggable, and the library is complete without it: with no
/// provider the `V-4xx` rules do not run and nothing else changes.
///
/// No snapshot ships. Institution data goes stale — banks merge, branches
