 ...
 * }</pre>
 *
 * <p><strong>Never throws</strong> (R-V1). Not for a malformed file, not for a
 ...
 *
 * <p>Thread-safe and reusable once built: the rules are stateless and the
...
public final class ZenginValidator {
     ...
     *
     * <p>A file that cannot be <em>read</em> — wrong record length throughout,
    ...
    public static final class Builder {
         ...
         *
         * <p>Institutional practice varies enough that some rule here will be
        ...
        /**
         * Supplies a business calendar, enabling the {@code V-5xx} rules.
         *
        ...
        /**
         * Supplies reference data, enabling the {@code V-4xx} rules.
         *
        ...
        /**
         * Sets how the yearless {@code MMDD} dates get a year.
         *
         ...
         *
         * <p>Worth setting when the file may not be a Zengin file at all: if
         ...
         *
         * <p>Off by default, so the careless path is the safe one. Findings
