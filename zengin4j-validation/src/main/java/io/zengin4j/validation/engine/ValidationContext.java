...
///
/// Two of the four are optional, and that is the point of R-V5 and R-V6: the
...
public final class ValidationContext {
    ...
    /// How to attach a year to the yearless `MMDD` dates.
    ///
    /// Needed by the calendar rules, and an explicit choice rather than a
    ...
    /// (R-E6).
    ///
    /// Account numbers reach logs, tickets and CI annotations. Masking by
    ...
    /// @return the value to put in a finding, never `null`
