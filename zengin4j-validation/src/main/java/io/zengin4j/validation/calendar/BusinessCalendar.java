 ...
 *
 * <p>Optional. Every rule that needs one is skipped when none is supplied, and
...
public interface BusinessCalendar {
     ...
     * @return {@code true} if it is a financial-institution business day
     ...
     *
     * <p>Japanese public holidays are <strong>announced, not computed</strong>.
     ...
     *
     * @return the last date this calendar covers, never {@code null}
     */
