...
///
/// **A finding says where.** Not "the trailer is wrong" but
/// record 4, byte 366, field `totalAmount` — because the person reading it
...
///
/// Both languages are carried at once rather than resolved against a locale
...
/// @param ruleId        the rule that produced it, for example `V-301`;
...
public record Finding(
    ...
    /// report (INV-7).
    ///
    /// By position first, because that is how the report will be read — down
    ...
    ///
    /// Japanese for `ja`, English for everything else — not because
    ...
    /// Assembles a finding.
    ///
    /// Most of a finding's components are optional and most rules set a
