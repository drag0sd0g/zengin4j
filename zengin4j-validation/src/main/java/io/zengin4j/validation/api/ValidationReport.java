 ...
 *
 * <p>Returned, never thrown. A file with two hundred errors produces a report
 ...
 *
 * <p>Findings arrive canonically ordered (INV-7): the same file always produces
...
public final class ValidationReport {
     ...
     *
     * <p>SARIF describes the rules a run used, not just its results, so the
     ...
     *
     * @return the findings, never {@code null}
     */
     ...
     *
     * <p>Defined on errors alone. Warnings are things worth looking at that
     ...
     *
     * @param locale the language to render in; Japanese for {@code ja}
     ...
     *
     * @return the rules, possibly empty, never {@code null}
     */
     ...
     *
     * <p>Renders natively as annotations in GitHub, GitLab and Azure DevOps, so
